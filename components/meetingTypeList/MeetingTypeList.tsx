...
import MeetingModel from "../meetingmodel/MeetingModel"
    ...
    return (
        <section className="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-4">
            <HomeCard
                ...
                hendleClick={() => setMeetingState('isInstantMeeting')}
            ...
            <HomeCard
                ...
                hendleClick={() => setMeetingState('isScheduleMeeting')}
                className= 'bg-blue-1'
            />
            <HomeCard
                ...
                hendleClick={() => router.push('/recordings')}
            ...
            <HomeCard
                ...
                hendleClick={() => setMeetingState('isJoiningMeeting')}
